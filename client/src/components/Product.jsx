...
const Product = () => {
  ...
  return (
    <div>
      <div className="max-w-screen-xl mx-auto my-10 flex flex-col lg:flex-row p-4 gap-10">
        <div>
          <img
            src={details.image}
            alt=""
        ...
        <div className="lg:w-3/5  flex flex-col justify-center gap-12">
          <div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4">
            <div className="w-full lg:w-52 flex items-center p-3 justify-between border gap-4 ">
            ...
            <button
              ...
              className="bg-black text-white py-3 px-6 w-full lg:w-52 rounded-lg active:bg-gray-800"
            >
              Add to cart
            </button>
          </div>
